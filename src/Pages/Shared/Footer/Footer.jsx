...
const Footer = () => {
    return (
        <footer className="bg-black">
            <div className="footer p-10 text-base-content text-white">
                <div>
                    <img src={logo} className='w-16 h-16' alt="" />
                    <p className='text-lg'>MARTIAL ARTS<br /> CINA Industries Ltd.<br />Providing reliable tech since 1992</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div className="form-control w-52">
                        ...
                        <div className="relative">
                            ...
                            <button className="btn btn-error absolute text-xs top-0 right-0 rounded-l-none">Subscribe</button>
                        </div>
                    </div>
            ...
            <p className='p-4 text-center text-white'><span>©Copyright 2023 Alright</span></p>
        </footer>
    );
};
