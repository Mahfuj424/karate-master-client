          ...
          {testimonials.map((testimonial) => (
            <SwiperSlide key={testimonial.id}>
              <div data-aos="fade-up"
                data-aos-easing="linear"
                data-aos-duration="1500" className="testimonial-item text-white hover:shadow-2xl  p-10 rounded-lg">
                  ...
                  <div className="testimonial-details">
                    ...
                    <div className="testimonial-review">
                      <blockquote className="flex">
                        <span className="quote-icon"><FaQuoteLeft className="text-gray-300" /></span>
                        <p className="testimonial-text text-white">{testimonial.review}</p>
                        <br />
                        <span className="quote-icon1"><FaQuoteRight className="text-gray-300" /></span>
                      </blockquote>
                    </div>
